<template>
    <div class="enterpriseDeliveryManagement">
        <div class="nav-top">
            <div class="nav-box">
                <img src="./icon-02.png"/>
                <p>删除</p>
        ...
        <el-dialog title="高级查询"
            ...
            <el-form :model="form">
                ...
                <el-form-item size="small" label="采发货单号：" :label-width="formLabelWidth">
                ...
                <el-form-item size="small" label="配送人：" :label-width="formLabelWidth">
                    <el-input v-model="form.name" autocomplete="off"></el-input>
                </el-form-item>
                <el-form-item size="small" label="收货人：" :label-width="formLabelWidth">
                    <el-input v-model="form.name" autocomplete="off"></el-input>
                </el-form-item>
            </el-form>
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            this.$store.state.navChildTit = '发货列表';
        },
        methods: {
