<template>
    <div class="purchasingManagement">
        <div class="nav-top">
            <div class="nav-box" @click="goPage">
                <img src="./icon-01.png"/>
                <p class="color-red">新增</p>
            </div>
            <div class="nav-box" @click="reveiwShow = true">
                <img src="./icon-01.png"/>
                <p class="color-red">复核</p>
            </div>
            <div class="nav-box">
                <img src="./icon-02.png"/>
                <p>删除</p>
        ...
        <div class="contain-mod">
            <div class="contain-top">
                ...
                <span class="search-btn">供应商：</span>
                <el-input size="mini" class="w106 mr30"></el-input>
                ...
                <span class="search-btn">采购申请人：</span>
                <el-input size="mini" class="w106 mr30"></el-input>
        ...
        <el-dialog title="高级查询"
            ...
            <el-form :model="form">
                ...
                <el-form-item size="small" label="采购单号：" :label-width="formLabelWidth">
                    <el-input v-model="form.name" autocomplete="off"></el-input>
                </el-form-item>
                <el-form-item size="small" label="供应商：" :label-width="formLabelWidth">
                    <el-input v-model="form.name" autocomplete="off"></el-input>
                </el-form-item>
                <el-form-item size="small" label="供应商电话：" :label-width="formLabelWidth">
                    <el-input v-model="form.name" autocomplete="off"></el-input>
                </el-form-item>
                <el-form-item size="small" label="采购申请人：" :label-width="formLabelWidth">
                    <el-input v-model="form.name" autocomplete="off"></el-input>
                </el-form-item>
                <el-form-item size="small" label="采购复核人：" :label-width="formLabelWidth">
                    <el-input v-model="form.name" autocomplete="off"></el-input>
                </el-form-item>
            </el-form>
