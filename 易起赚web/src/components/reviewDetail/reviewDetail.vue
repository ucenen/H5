    ...
    <div class="reviewDetail">
        ...
        <div class="retail-contain">
            ...
            <div class="retail-top">
                <el-steps :space="300" :active="1" finish-status="success" align-center>
                    <el-step title="门店下单" description="2019/10/22 10:30"></el-step>
                    <el-step title="门店付款"></el-step>
                    <el-step title="示范区发货"></el-step>
                    <el-step title="门店收货"></el-step>
                </el-steps>
            </div>
                    ...
                    <div class="retail-table">
                        <el-table
                                ...
                                <template slot-scope="scope">
                                    ...
                                    <el-popover
                                        ...
                                        <div class="money-box">
                                            ...
                                            <el-button size="mini" @click="visibleShow = false" type="text">取消</el-button>
                                        </div>
                                        <p class="money-tip" slot="reference" @click="visibleShow = true">￥1299.00<span class="el-icon-edit-outline"></span></p>
                                    </el-popover>
                                </template>
                            </el-table-column>
                            <el-table-column
                            ...
                            <el-table-column
                                ...
                                <template slot-scope="scope">
                                    <!--scope.row-->
                                    <span class="scope_btn color-blue color-under-line" @click="reviewShow = true">替换商品</span>
                                    <span class="scope_btn" @click="delwShow = true">删除商品</span>
                                </template>
                            </el-table-column>
                        </el-table>
                    </div>
                ...
                <div class="order-contain">
                    <div class="retail-table">
                        <div class="return-mod">
                            ...
                            <div class="return-box">
                                <span class="return-l">开票类型</span>
                                <div class="return-r-box">
                                    <div class="radio-box">
                                        <el-radio v-model="radio" size="mini" label="1">结算单</el-radio>
                                        <el-radio v-model="radio" size="mini" label="2">普通</el-radio>
                                        <el-radio v-model="radio" size="mini" label="3">增值税专用发票</el-radio>
                                    </div>
                                </div>
                            </div>
                            <div class="return-box">
                                <span class="return-l">开票形式</span>
                                <div class="return-r-box">
                                    <div class="sel-box">
                                        <el-select size="mini" v-model="value" placeholder="请选择">
                                            <el-option
                    ...
                    <div class="retail-table">
                        <div class="return-mod">
                            <div class="return-box">
                                <span class="return-l">订单复核</span>
                                <div class="return-r-box">
                                    <div class="radio-box">
                                        <el-radio v-model="radio" size="mini" label="1">复核通过</el-radio>
                                        <el-radio v-model="radio" size="mini" label="2">复核拒绝</el-radio>
                                    </div>
                                </div>
                            </div>
                            <div class="return-box">
                                <span class="return-l">复核备注</span>
                                <div class="return-r-box">
                                    <div class="sel-box">
                                        <el-input size="mini" placeholder="请输入内容"></el-input>
                                    </div>
        ...
        <el-dialog
            ...
            <div class="tip-contain">
                ...
                <p>替换为：<el-input size="mini" class="review-ipt" placeholder="请输入内容"></el-input></p>
            </div>
