<template>
    <div class="purchaseOrderDetail">
        ...
        <div class="retail-contain">
            ...
            <div class="order-retail-box" style="padding-top: 50px;">
                <h4>订单信息</h4>
                <div class="order-contain">
                    <ul class="retail-inner-box w50">
                        <li>订单编号：{{detailData.shopPurchaseNo}}</li>
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            //this.countDown();
            this.getShopPurchaseDetailFn();
        },
        methods: {
            getShopPurchaseDetailFn() {
                this.loadingShow = true;
                MyPost('/yl-ms-platform/shopPurchase/getShopPurchaseDetail', {
                    ...
                    if (code == '0') {
                        ...
                        this.tableData = data.data.shopPurchaseDetailsList;
                    } else {
