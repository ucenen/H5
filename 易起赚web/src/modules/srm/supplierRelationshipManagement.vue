<template>
    <div class="supplierList">
        <div class="nav-top">
            ...
            <div class="nav-box" @click="isSupplierOpenAll(1)">
                <img src="static/img/qiyong.png"/>
                <p>启用</p>
            </div>
            <div class="nav-box" @click="isSupplierOpenAll(2)">
        ...
        <div class="contain-mod">
            <div class="contain-top">
                <span class="search-btn">供应商名称：</span>
                <el-input size="mini" class="w106 mr30" @keyup.enter.native="queryListFnMall"
                          v-model="search_list.name"></el-input>
                <span class="search-btn">供应商类型：</span>
                <el-tooltip class="w120 mr30" effect="dark" content="供应商类型" placement="top-start">
                    <el-select size="mini" placeholder="供应商类型" v-model="search_list.companyType">
                        <el-option
                                label="全部"
                                value="">
                        </el-option>
                ...
                <span class="search-btn">供应商状态：</span>
                <el-tooltip class="w120 mr30" effect="dark" content="供应商状态" placement="top-start">
                    <el-select size="mini" placeholder="供应商状态" v-model="search_list.status">
                        <el-option
                                label="全部"
                                value="">
                        </el-option>
                    ...
                    <el-table
                        ...
                        <el-table-column
                            ...
                            <template slot-scope="scope">
                                <span v-for="type in supplierType">
                                    {{ type.dictionaryKey==scope.row.companyType?type.dictionaryValue:'' }}
                                </span>
                            </template>
                        </el-table-column>
                        <el-table-column
                        ...
                        <el-table-column
                            ...
                            <template slot-scope="scope">
                                ...
                                <span class="scope_btn color-blue"
                                      v-if="scope.row.auditStatus==1"
                                      @click="isSupplierOpen(scope.row)">
        ...
        <el-dialog title="账号配置"
                   ...
                   :close-on-press-escape="false">
            <el-form>
                <el-form-item size="small" label="供应商编号：" :label-width="formAccountWidth">
                    <el-input v-model="accountItem.companyCode" :disabled="true" autocomplete="off"></el-input>
                </el-form-item>
                <el-form-item size="small" label="供应商名称：" :label-width="formAccountWidth">
                ...
                <el-form-item size="small" label="* 登录密码：":label-width="formAccountWidth">
                    <el-input :placeholder="passwordHolder" maxlength="20"  v-model="searchList.password" autocomplete="off"></el-input>
                </el-form-item>
        ...
        <el-dialog
                :title="supplierStatusTitle"
                :visible.sync="supplierStatusShow"
                width="30%"
                :close-on-click-modal="false"
                :close-on-press-escape="false">
            <div class="tip-contain">
                <p>正在执行{{supplierStatusTitle}}操作，是否确认{{supplierStatusTitle}}？</p>
            </div>
            <span slot="footer" class="dialog-footer">
                <el-button size="small" @click="supplierStatusShow = false">取 消</el-button>
                <el-button type="primary" size="small" @click="supplierStatusAll">确 定</el-button>
            </span>
        </el-dialog>
    </div>
</template>
    ...
    export default {
        ...
        methods: {
            ...
            reviewClick() {
                ...
                MyPost('/banyan-procurement/supplier/auditCompany', {
            ...
            queryListFn() {
                MyPost('/banyan-procurement/supplier/queryList', {
            ...
            supplierStatusAll() {
                ...
                this.loadingShow = true;
                MyPost('/banyan-procurement/supplier/statusAll', {
                    ids: this.delIds,
                    ...
                    if (code == '0') {
                        this.queryListFn()
                        this.$message({
                            message: this.supplierStatus == 1 ? '启用成功' : '禁用成功',
                            type: 'success'
                        });
                        this.supplierStatusShow = false
                    } else {
                        this.$message.error(message);
                    }
                })
            ...
            accountSet(item) {
                ...
                this.selectSupplierUserFn(item);
            },
            accountCommit() {
                ...
                this.loadingShow = true;
                MyPost('/banyan-procurement/supplier/configureAccount', {
                    id: this.sendId,
                    supplierId: this.accountItem.id,
