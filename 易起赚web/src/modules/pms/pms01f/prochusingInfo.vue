            ...
            <div class="tab-con" v-show="tabShow == 1">
                <table class="tab">
                    ...
                    <tr>
                        ...
                        <td>{{contentForm.purchaseAddress}}</td>

                        <td class="td_con">供应商编码</td>
                        <td>{{contentForm.supplierNo}}</td>

                    </tr>
                    <tr>
                        <td class="td_con">供应商</td>
                        <td>{{contentForm.supplierName}}</td>
                        <td class="td_con">供应商联系人</td>
                        <td>{{contentForm.supplierContact}}</td>
                        <td class="td_con">要求交货日期</td>
                        <td>{{contentForm.requiredDeliveryDate}}</td>

                    </tr>
                    <tr>
                        <td class="td_con">供应商电话</td>
                        <td>{{contentForm.supplierPhone}}</td>
                        <td class="td_con">供应商地址</td>
                        <td>{{contentForm.supplierAddress}}</td>
...
<!--                        <td>{{receiveForm.receiveType==1?'收货':'收货并入库'}}</td>-->
        ...
        methods: {
                ...
                MyPost('/banyan-procurement/purchase/querySettlementWay', {}).then((res) => {
                    ...
                    if (code == '0') {
                        for (var i = 0; i < data.length; i++) {
                            if (data[i].dictionaryKey == this.contentForm.settlementMethod)
            ...
            getProchusType() {
                MyPost('/banyan-procurement/purchase/queryPurchaseWay', {}).then((res) => {
                    ...
                    if (code == '0') {
                        for (var i = 0; i < data.length; i++) {
                            if (data[i].dictionaryKey == this.contentForm.purchaseWay) {
            ...
            queryRecFn() {
                MyPost('/banyan-procurement/receive/queryByPurchaseId', {
