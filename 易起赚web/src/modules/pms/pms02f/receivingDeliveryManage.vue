    ...
    <div class="prochusingManagement">
        ...
        <div class="contain-mod">
            <div class="contain-top">
                ...
                <el-select class="w100 mr30" size="mini" placeholder="入库类型" v-model="searchList.warehouseOrderType">
                    <el-option
                            label="全部"
                            value="">
                    </el-option>
                ...
                <el-select class="w88 mr30" size="mini" placeholder="复核状态" v-model="searchList.reviewerStatus">
                    <el-option
                            label="全部"
                            value="">
                    </el-option>
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            this.$store.state.navChildTit = '酒企发货';
        ...
        methods: {
            ...
            queryListFn() {
                MyPost('/banyan-inventory/warehouse/in/queryList', {
