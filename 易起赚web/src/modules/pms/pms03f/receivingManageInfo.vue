        ...
        <div class="infor-mod-2">
            <div class="infor-tab-all">
                <div class="infor-tab">
                    ...
                    <span :class="tabShow == 4 ? 'tab-on' : ''" @click="tabClk(4)">送货信息</span>
            ...
            <div class="tab-con" v-show="tabShow == 1">
                <table class="tab">
                    <tr>
                        <td class="td_con">收货单号</td>
                        <td v-if="type==1">{{contentForm.receiveNo}}</td>
                        <td v-else>
                        ...
                        <td v-if="type==1">{{contentForm.receiveDate}}</td>
                        <td v-else>
                            <el-input v-model="titData">
                            </el-input>
                        </td>
                    ...
                    <tr>
                        <td class="td_con">收货类型</td>
                        <td v-if="type==1">{{contentForm.receiveType}}</td>
                        <td v-else>
                            <el-input v-model="titData">
                            </el-input>
                        </td>
                        ...
                        <td v-if="type==1">{{contentForm.receivePerson}}</td>
                        <td v-else>
                            <el-input v-model="titData">
                            </el-input>
                        </td>
                    ...
                    <tr>
                        ...
                        <td v-if="type==1">{{contentForm.receiveDepartment}}</td>
                        <td v-else>
                            <el-input v-model="titData">
                            </el-input>
                        </td>
                        <td class="td_con">收货人员电话</td>
                        <td v-if="type==1">{{contentForm.receivePersonPhone}}</td>
                        <td v-else>
                            <el-input v-model="titData">
                            </el-input>
                        </td>
            ...
            <div class="tab-con" v-show="tabShow == 4">
                <table class="tab">
                    <tr>
                        <td class="td_con">送货单号</td>
                        <td v-if="type==1">{{contentForm.sendNo}}</td>
                        <td v-else>
                            <el-input v-model="titData">
                            </el-input>
                        </td>
                        <td class="td_con">送货日期</td>
                        <td v-if="type==1">{{contentForm.sendDate}}</td>
                        <td v-else>
                            <el-input v-model="titData">
                            </el-input>
                        </td>
                        <td class="td_con">配送车牌号</td>
                        <td v-if="type==1">{{contentForm.distributionCartNo}}</td>
                        <td v-else>
                            <el-input v-model="titData">
                            </el-input>
                        </td>
                    ...
                    <tr>
                        <td class="td_con">送货人电话</td>
                        <td v-if="type==1">{{contentForm.sendPersonPhone}}</td>
                        <td v-else>
                            <el-input v-model="titData">
                            </el-input>
                        </td>
                        <td class="td_con">送货人</td>
                        <td v-if="type==1">{{contentForm.sendPerson}}</td>
                        <td v-else>
                            <el-input v-model="titData">
                            </el-input>
                        </td>
                        <td class="td_con">送货单位</td>
                        <td v-if="type==1">{{contentForm.sendDepartment}}</td>
                        <td v-else>
                            <el-input v-model="titData">
                            </el-input>
                        </td>
                        ...
                        if (code == '0') {
                            ...
                            for (let i=0;i<this.warehouseTypeList.length;i++){
                                if (this.warehouseTypeList[i].dictionaryKey==dictionaryKey){
                                    this.contentForm.receiveType = this.warehouseTypeList[i].dictionaryValue;
                                }
                            }
            ...
            getWarehouseInfo(){
                MyPost('/banyan-procurement/purchaseReceive/order/queryById', {
                    ...
                    if (code == '0') {
                        ...
                        if (this.contentForm.creationTime){
                            this.contentForm.creationTime= this.timeFormatYYMMDD(this.contentForm.creationTime);
                        }
                        if (this.contentForm.receiveDate){
                            this.contentForm.receiveDate= this.timeFormatYYMMDD(this.contentForm.receiveDate);
                        }
                        if (this.contentForm.sendDate){
                            this.contentForm.sendDate= this.timeFormatYYMMDD(this.contentForm.sendDate);
                        }
                        if (this.contentForm.reviewerDate){
                        ...
                        this.getQueryInWarehouseType(data.receiveType);
