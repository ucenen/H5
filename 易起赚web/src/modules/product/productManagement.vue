<template>
    <div class="supplierList">
        <div class="nav-top">
            ...
            <!--<div class="nav-box" @click="goAddLiveBroadcast">
        ...
        <div class="contain-mod">
            <div class="contain-top">
                ...
                <el-input size="mini" class="w106 mr30" @keyup.enter.native="queryListFnMall"
                          v-model="search_list.spuNo"></el-input>
                <span class="search-btn">产品名称：</span>
                <el-input size="mini" class="w106 mr30" @keyup.enter.native="queryListFnMall"
                          v-model="search_list.productName"></el-input>
                <span class="search-btn">品牌名称：</span>
                <el-input size="mini" class="w106 mr30" @keyup.enter.native="queryListFnMall"
                          v-model="search_list.brandName"></el-input>
                <span class="search-btn">分类名称：</span>
                <el-input size="mini" class="w106 mr30" @keyup.enter.native="queryListFnMall"
                          v-model="search_list.categoryName"></el-input>
                        ...
                        <el-table-column
                            ...
                            <template slot-scope="scope">
                                <span class="scope_btn color-blue"
                                      @click="goAddLiveBroadcast(scope.row)">直播</span>

                                <span class="scope_btn color-blue"
                                      @click="goAddBringGoodsVideo(scope.row)">视频</span>

                                <span class="scope_btn color-blue"
                                      @click="goSkuPriceList(scope.row)">sku</span>
