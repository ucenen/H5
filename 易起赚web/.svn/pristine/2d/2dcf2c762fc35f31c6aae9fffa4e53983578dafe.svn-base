<template>
    <div class="storeStaff">
        <div class="nav-top">
            <div class="nav-box">
                <img src="./icon-01.png"/>
                <p class="color-red" @click="addStaffShow = true">新增</p>
            </div>
            <div class="nav-box">
                <img src="./icon-02.png"/>
                <p>删除</p>
        ...
        <div class="contain-mod">
            <div class="contain-top">
                ...
                <span class="search-btn">用户电话：</span>
                <el-input size="mini" class="w106 mr30"></el-input>
                    ...
                    <el-table
                        ...
                        <el-table-column
                            ...
                            <template slot-scope="scope">
                                ...
                                <span class="scope_btn color-blue" @click="goInfor">编辑</span>
        ...
        <el-dialog title="新增用户"
                   ...
                   :close-on-press-escape="false">
            <el-form :model="form">
                <el-form-item size="small" label="* 用户名称：" :label-width="formLabelWidth">
                    <el-input v-model="form.name" autocomplete="off"></el-input>
                </el-form-item>
                <el-form-item size="small" label="* 用户姓名：" :label-width="formLabelWidth">
                    <el-input v-model="form.name" autocomplete="off"></el-input>
                </el-form-item>
                <el-form-item size="small" label="* 邮箱地址：" :label-width="formLabelWidth">
                    <el-input v-model="form.name" autocomplete="off"></el-input>
                </el-form-item>
                <el-form-item size="small" label="* 所属部门：" :label-width="formLabelWidth">
                    <el-select v-model="form.region" placeholder="请选择活动区域" style="width:100%">
                        <el-option label="区域一" value="shanghai"></el-option>
                        <el-option label="区域二" value="beijing"></el-option>
                    </el-select>
                    <span class="staff-tip">选择所属部门后默认继承部门权限，可在用户列表中单独设置权限</span>
                </el-form-item>
                <el-form-item size="small" label="* 登录密码：" :label-width="formLabelWidth">
                    <el-input v-model="form.name" autocomplete="off"></el-input>
                </el-form-item>
                <el-form-item size="small" label="* 确认密码：" :label-width="formLabelWidth">
                    <el-input v-model="form.name" autocomplete="off"></el-input>
                </el-form-item>
                <el-form-item size="small" label="备注信息：" :label-width="formLabelWidth">
                    <el-input
                            type="textarea"
                            :rows="3"
                            placeholder="请输入内容"
            ...
            <div slot="footer" class="dialog-footer">
                <el-button size="small" @click="addStaffShow = false">取消</el-button>
                <el-button size="small" type="primary" @click="addStaffShow = false">确定</el-button>
            </div>
        </el-dialog>
    </div>
</template>
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            this.$store.state.navChildTit = '门店员工';
        },
        methods: {
