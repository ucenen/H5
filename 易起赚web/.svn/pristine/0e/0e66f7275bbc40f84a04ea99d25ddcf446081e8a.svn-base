            ...
            <div class="tab-con" v-show="tabShow == 3">
                <table class="tab">
                    <tr>
                        ...
                        <td v-if="type==1">{{contentForm.reviewerPerson}}</td>
                        <td v-else>
                            <el-input v-model="titData">
                            </el-input>
                        </td>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getQueryOutWarehouseType(dictionaryKey){
                ...
                MyPost('/banyan-inventory/warehouse/out/queryById', {
                    ...
                    if (code == '0') {
                        this.contentForm={
                            ...
                            reviewerPerson: data.reviewerPersonName,
                        ...
                        this.getQueryOutWarehouseType(data.warehouseOrderType);
                    } else {
                        this.$confirm(message, '提示', {
                            confirmButtonText: '确定',
                            showCancelButton: false,
