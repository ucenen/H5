    ...
    <div class="systemSet">
        ...
        <div class="infor-mod">
            ...
            <div class="add-mod-one">
                ...
                <div class="add-box">
                    <span class="add-tip"><i style="color: red">*</i> 所属门店：</span>
                ...
                <template v-if="edit==1">
                    ...
                    <div class="add-box">
                        ...
                        <el-input maxlength="50" size="small" class="add-ipt" :disabled="true"
                            ...
                            contentForm.reviewerStatus == 4?'已作废':''"></el-input>
                    </div>
                    <div class="add-box" style="width: 100%;height: 60px;overflow: hidden">
                        <span class="add-tip" style="width: 11%">复核备注：</span>
                        <el-input maxlength="50" size="small" class="add-ipt" :disabled="true"  type="textarea" style="width: 52.5%"
                    ...
                    <el-table
                        ...
                        <el-table-column
                            ...
                            <template slot-scope="scope">
                                <el-input type="tel"  @mousewheel.native.prevent
                                          @mousewheel.native.prevent
                                          @input="saveTable(scope.row)"
                                          oninput="if(value.length>8)value=value.slice(0,8)"
                                          v-model="scope.row.purchaseNumber"></el-input>
                            </template>
                        </el-table-column>
                        <el-table-column
                                prop="quantityUnit"
                        ...
                        <el-table-column
                            ...
                            <template slot-scope="scope">
                                ...
                                <el-input style="margin-left: 6px" type="tel"  @mousewheel.native.prevent
                                          @input="saveTable(scope.row)"
                                          oninput="if(value.length>8)value=value.slice(0,8)"
                                          v-model="scope.row.unitPrice"></el-input>
                                </span>
                            </template>
                        </el-table-column>
                        <el-table-column
                                label="总金额">
                            <template slot-scope="scope">
                                <span>¥ {{caculate(scope.row.purchaseNumber,scope.row.unitPrice)}}</span>
                            </template>
                        </el-table-column>
                    </el-table>
                </div>
        ...
        <el-dialog :title="titData"
            ...
            <div class="add-contain" style="padding: 0 20px">
                <div class="contain-top">
                    ...
                    <el-cascader class="w106 mr30 hidden-lg-and-down" @keyup.enter.native="queryListFnMall"
    ...
    export default {
        ...
        methods: {
            ...
            saveAll(strStyle) {
                ...
                if (!this.contentForm.purchaseCompany) {
                ...
                let url = "";
                if (strStyle == "1") {
                    url = '/polaris/purchase/update'
                } else {
                    url = '/polaris/purchase/save'
                }
