        ...
        <div class="infor-mod">
            <div class="infor-tab-all">
                <div class="infor-tab">
                    ...
                    <!--<span :class="tabShow == 4 ? 'tab-on' : ''" @click="tabClk(4)">附件</span>-->
                </div>
            </div>
            <div class="tab-con" v-show="tabShow == 1">
                <table class="tab">
                    <tr>
                        <td class="td_con">盘点单号</td>
                        <td v-if="type==1">{{contentForm.checkNo}}</td>
                        <td v-else>
                        ...
                        <td class="td_con">盘点日期</td>
                        <td v-if="type==1">{{contentForm.checkDate}}</td>
                        <td v-else>
                            <el-input v-model="titData">
                            </el-input>
                        </td>
                    ...
                    <tr>
                        <td class="td_con">盘点部门</td>
                        <td v-if="type==1">{{contentForm.checkDepartment}}</td>
                        <td v-else>
                            <el-input v-model="titData">
                            </el-input>
                        </td>
                        <td class="td_con">盘点人员</td>
                        <td v-if="type==1">{{contentForm.checkPerson}}</td>
                        <td v-else>
                            <el-input v-model="titData">
                            </el-input>
                        </td>
                        <td class="td_con">盘点人员电话</td>
                        <td v-if="type==1">{{contentForm.checkPersonPhone}}</td>
                        <td v-else>
                            <el-input v-model="titData">
                            </el-input>
                        </td>
                    ...
                    <tr>
                        <td class="td_con">盘点类型</td>
                        <td v-if="type==1">{{contentForm.checkType}}</td>
                        <td class="td_con">盘点仓库</td>
            ...
            <!--<div class="tab-con" v-show="tabShow == 4">-->
                <!--<table class="tab">-->
                    <!--<tr>-->
                        <!--<td class="td_con">附件1</td>-->
                        <!--<td v-if="type==1"></td>-->
                        <!--<td v-else>-->
                            <!--<el-input v-model="titData">-->
                            <!--</el-input>-->
                        <!--</td>-->
                        <!--<td class="td_con">附件2</td>-->
                        <!--<td v-if="type==1"></td>-->
                        <!--<td v-else>-->
                            <!--<el-input v-model="titData">-->
                            <!--</el-input>-->
                        <!--</td>-->
                        <!--<td class="td_con">附件3</td>-->
                        <!--<td v-if="type==1"></td>-->
                        <!--<td v-else>-->
                            <!--<el-input v-model="titData">-->
                            <!--</el-input>-->
                    ...
                    <!--</tr>-->
                    <!--<tr>-->
                        <!--<td class="td_con">附件4</td>-->
                        <!--<td v-if="type==1"></td>-->
                        <!--<td v-else>-->
                            <!--<el-input v-model="titData">-->
                            <!--</el-input>-->
                        <!--</td>-->
                        <!--<td class="td_con">附件5</td>-->
                        <!--<td v-if="type==1"></td>-->
                        <!--<td v-else>-->
                            <!--<el-input v-model="titData">-->
                            <!--</el-input>-->
                        <!--</td>-->
                        <!--<td class="td_con">附件6</td>-->
                        <!--<td v-if="type==1"></td>-->
                        <!--<td v-else>-->
                            <!--<el-input v-model="titData">-->
                            <!--</el-input>-->
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getWarehouseInfo(){
                MyPost('/banyan-inventory/inventory/check/queryById', {
                    ...
                    if (code == '0') {
                        ...
                        this.getQueryOutWarehouseType(data.checkType);
                    } else {
            ...
            getQueryOutWarehouseType(dataType){
                MyPost('/banyan-inventory/inventory/check/queryCheckInventoryType', {
                    ...
                    if (code == '0') {
                        ...
                        for(let i=0;i<this.warehouseTypeList.length;i++){
                            if (dataType==this.warehouseTypeList[i].dictionaryKey){
                                this.contentForm.checkType=this.warehouseTypeList[i].dictionaryValue;
                            }
                        }
                    } else {
                        this.$confirm(message, '提示', {
